...
public class Customer {
    ...
    private Integer customer_referral_id;
    private Integer customer_referred_by;
    ...
    public Integer getCustomer_referral_id() {
        return customer_referral_id;
    }

    public void setCustomer_referral_id(Integer customer_referral_id) {
        this.customer_referral_id = customer_referral_id;
    }

    public Integer getCustomer_referred_by() {
        return customer_referred_by;
    }

    public void setCustomer_referred_by(Integer customer_referred_by) {
