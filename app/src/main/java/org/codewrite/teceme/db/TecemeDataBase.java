...
@Database(entities = {CustomerEntity.class, CategoryEntity.class, CartEntity.class, OrderEntity.class,
        ProductEntity.class, StoreEntity.class, WalletEntity.class, WalletLogEntity.class,
        WishListEntity.class, AccessTokenEntity.class},version = 1, exportSchema = false)
