...
public class CheckoutAdapter extends ListAdapter<CartEntity, CheckoutAdapter.ProductViewHolder> {
     ...
     */
    public CheckoutAdapter(Activity activityContext) {
        super(DIFF_CALLBACK);
    ...
    public void onBindViewHolder(@NonNull final ProductViewHolder holder, final int position) {
        ...
        if (holder.productPrice != null) {
            String price = entity.getCart_quantity()+" Qty x "
                    + "GH₵ ".concat(entity.getProduct_price())+" = "
                    + "GH₵ ".concat(String.valueOf(Double.parseDouble(entity.getProduct_price().trim())
                    *entity.getCart_quantity()));
